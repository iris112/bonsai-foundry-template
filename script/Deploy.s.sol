...
/// @notice Deployment script for the ZKOptimalAllocation project.
...
contract Deploy is Script, BonsaiCheats, BonsaiDeploy {
    function run() external {
        ...
        console2.log("Image ID for OPTIMAL_ALLOCATION is ", vm.toString(imageId));
        ZKOptimalAllocation app = new ZKOptimalAllocation(bonsaiRelay, imageId);
        console2.log("Deployed ZKOptimalAllocation to ", address(app));
